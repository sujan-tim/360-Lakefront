...
export async function POST(request: Request) {
  try {
    ...
    const totalNprBase = usdCentsToNprRupees(totalAmountCents, USD_TO_NPR_RATE);
    const discount = applyNprPercentageDiscount(totalNprBase);
    ...
    const booking = await prisma.booking.create({
      data: {
        ...
        totalAmountCents,
        exchangeRateNprPerUsd: USD_TO_NPR_RATE,
        totalAmountNprBase: discount.base,
        totalAmountNpr: discount.discounted,
        discountNpr: discount.discount,
